...
--
-- Host: localhost
-- Erstellungszeit: 22. Jun 2026 um 11:31
...
CREATE TABLE `einstellungen` (
  ...
  `nc_api_key_stundenplan` varchar(255) DEFAULT NULL,
  `nc_api_key_stammdaten` varchar(255) DEFAULT NULL,
...
--
-- Tabellenstruktur für Tabelle `mediathek`
--
...
CREATE TABLE `mediathek` (
  ...
  `breite` smallint(5) UNSIGNED DEFAULT NULL,
  `hoehe` smallint(5) UNSIGNED DEFAULT NULL,
...
INSERT INTO `modul_instanzen` (`id`, `modul_typ`, `name`, `einstellungen`, `aktiv`, `erstellt_am`, `geaendert_am`) VALUES
(14, 'bild', 'Test Bilder', '{\"intervall_sek\":5,\"uebergang\":\"fade\",\"bildmodus\":\"cover\"}', 1, '2026-06-20 10:53:04', '2026-06-20 10:53:04');
...
CREATE TABLE `modul_instanz_inhalte` (
  ...
  `mediathek_id` int(10) UNSIGNED DEFAULT NULL,
...
INSERT INTO `modul_instanz_inhalte` (`id`, `modul_instanz_id`, `mediathek_id`, `dateiname`, `text_inhalt`, `gueltig_bis`, `reihenfolge`, `dauer_sek`, `aktiv`) VALUES
(29, 14, NULL, 'bild_14_4449c915b68a.jpg', NULL, NULL, 0, 10, 1),
(30, 14, NULL, 'bild_14_97bc060f302e.png', NULL, NULL, 1, 10, 1),
(31, 14, NULL, 'bild_14_a2f9fe6ae8d5.png', NULL, NULL, 2, 10, 1);
...
--
-- Indizes für die Tabelle `mediathek`
--
ALTER TABLE `mediathek`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_hash` (`datei_hash`);
...
--
-- AUTO_INCREMENT für Tabelle `mediathek`
--
ALTER TABLE `mediathek`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `modul_instanz_inhalte`
  ADD CONSTRAINT `fk_inhalte_mediathek` FOREIGN KEY (`mediathek_id`) REFERENCES `mediathek` (`id`) ON DELETE SET NULL,
