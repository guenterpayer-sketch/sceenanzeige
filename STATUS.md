...
_Letzte Aktualisierung: Schritt 19–21 live ✅ — Modul-Übergänge (Overlay-Dissolve + Settle), Slide-Engine (alle 7 Module, Adapter raus), Uhr Analog + Hintergrundbild/Pill, Setting-Typ `mediathek_bild`._
