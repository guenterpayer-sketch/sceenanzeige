...
| 17 | Modul `veranstaltung` — adaptives Layout: Hochkant (Bild+Text nebeneinander) / Querformat (Vollbild+Overlay) / Kein Bild; Proxy liefert `bild_breite`/`bild_hoehe`; Textschatten für beliebige Hintergründe | ✅ geliefert, noch nicht live getestet |
