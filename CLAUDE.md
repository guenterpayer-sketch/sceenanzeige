...
| 20 | Slide-Engine: Module liefern nur Inhalt, Engine besitzt Präsentation (Konzept + Stand: `KONZEPT_SLIDE_ENGINE.md`) | 🧪 Etappe 1 ✅ · Etappe 2 ✅ · Etappe 3 (alle Module, Adapter entfernt) auf Staging |
| 21 | Uhr-Modul: Analog-Zifferblatt (SVG) + Hintergrundbild/Transparenz-Pill; neuer Setting-Typ `mediathek_bild` (Registry + Picker in `instanz.php`) | 🧪 auf Staging |
