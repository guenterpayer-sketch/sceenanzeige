...
| 17 | Modul `veranstaltung` — adaptives Layout: Hochkant / Querformat / Kein Bild; Proxy liefert `bild_breite`/`bild_hoehe`; Text ab 55 % von oben; Gradient 0–55 % transparent; Datum #e03535 38 px; Wochentage ausgeschrieben; padding-bottom auf Titel gegen Unterlängen-Clipping | ✅ Staging getestet, bereit für Live-Merge |
