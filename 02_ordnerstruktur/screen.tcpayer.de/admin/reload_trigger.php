 ...
 *
 * Leert zusätzlich den Stundenplan-Cache (includes/NcCache.php): Die
 * Nimbuscloud-Daten werden sonst bis Mitternacht gehalten, um das
 * API-Kontingent zu schonen. „Monitore neu laden" ist damit der bewusste
 * Weg, nach einer Stundenplan-Änderung frische Daten zu ziehen — die
 * Monitore holen sie beim Reload direkt mit.
 *
